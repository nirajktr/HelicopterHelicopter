...
public class HelicopterForm implements MouseListener
{
    ...
    public void initiate()
    {
        ...
        helicopter = new MovingImage("theodore.jpg",XPOS,270);

        for(int x = 0; x < NUMRECS; x++)
            toprecs.add(new MovingImage("pdiddy.jpg",RECWIDTH*x,30));
        for(int x = 0; x < NUMRECS; x++)
            bottomrecs.add(new MovingImage("pdiddy.jpg",RECWIDTH*x,450));

        middlerecs.add(new MovingImage("pdiddy.jpg",1392,randomMidHeight()));
        middlerecs.add(new MovingImage("pdiddy.jpg",1972,randomMidHeight()));
    ...
    public void updateRecs()
    {
        ...
        {
            toprecs.set(x,new MovingImage("pdiddy.jpg",RECWIDTH*x,toprecs.get(x+1).getY()));
            bottomrecs.set(x,new MovingImage("pdiddy.jpg",RECWIDTH*x,bottomrecs.get(x+1).getY()));
        }
        lastRec();
    }
    ...
    {
        toprecs.set((NUMRECS - 1),new MovingImage("pdiddy.jpg",RECWIDTH*(NUMRECS - 1),toprecs.get(26).getY() + moveIncrement));
        bottomrecs.set((NUMRECS - 1),new MovingImage("pdiddy.jpg",RECWIDTH*(NUMRECS - 1),bottomrecs.get(26).getY() + moveIncrement));
    }
    ...
    public void updateMiddle()
    {
        ...
        {
            middlerecs.set(0,new MovingImage("pdiddy.jpg",middlerecs.get(0).getX() - (RECWIDTH/5), middlerecs.get(0).getY()));
            middlerecs.set(1,new MovingImage("pdiddy.jpg",middlerecs.get(1).getX() - (RECWIDTH/5), middlerecs.get(1).getY()));
        }
        else
        {
            middlerecs.set(0,new MovingImage("pdiddy.jpg",middlerecs.get(1).getX() - (RECWIDTH/5), middlerecs.get(1).getY()));
            middlerecs.set(1,new MovingImage("pdiddy.jpg",middlerecs.get(0).getX() + 580,randomMidHeight()));
        }
    }
